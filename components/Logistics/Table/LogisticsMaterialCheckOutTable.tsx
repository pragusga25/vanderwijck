...
const LogisticsMaterialCheckout: React.FC<{ data: LogisticsMaterialCheckoutData[] }> = ({ data }) => {
  return (
    <div style={{ minWidth: '900px' }} className="w-full px-1 overflow-x-auto text-center">
      <table className="w-full">
        <thead className="text-sm">
          <tr>
            <th className="w-1/4">Project No</th>
            <th className="w-1/4">Transaction Number</th>
            <th className="w-2/6">Item Name</th>
